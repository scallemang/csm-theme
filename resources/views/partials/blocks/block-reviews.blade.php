...
@endif
<section @if($sectionId)id="{{ $sectionId }}"@endif class="block-hero py-lg-5 pt-5 @if( !($heading && $subheading) ) block-hero--image-only @endif" @if( $image ) style="background-image: url('{{ $image['url'] }}'); background-size: cover; background-position: center;" @endif> 
